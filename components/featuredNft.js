...
export default function featuredNft() {
  return (
    <div className="flex flex-col items-start justify-center gap-4 w-full">
      <h2 className="text-5xl font-bold">Featured NFTs</h2>
      <p>Discover the most outstanding NFTs in all topics of life.</p>
      <div className="flex items-center justify-center gap-16 my-8">
        <p className="cursor-pointer font-bold text-lg">NFTs</p>
        <p className="cursor-pointer font-bold text-lg">Arts</p>
        <p className="cursor-pointer font-bold text-lg">Musics</p>
        <p className="cursor-pointer font-bold text-lg">Sports</p>
        <p className="cursor-pointer font-bold text-lg">Photography</p>
      </div>
      <div className="grid grid-cols-3 gap-12 w-full">
        {Array.from({ length: 6 }).map((item, index) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-[350px] flex flex-col items-start justify-center bg-[#181C14] p-2 gap-2 rounded-tr-[300px]">
